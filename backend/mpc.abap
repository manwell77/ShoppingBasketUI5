class ZCL_ZENISB_MPC definition
  public
...
public section.
  ...
  types:
  begin of TS_HEADER,
     WORKITEMID type C length 12,
     BASKETGUID type SYSUUID_X,
     BASKETNUMBER type C length 10,
...
TT_HEADER type standard table of TS_HEADER. .
  ...
  begin of TS_ITEM,
     WORKITEMID type C length 12,
     ITEMID type C length 10,
     BASKETGUID type SYSUUID_X,
     ITEMGUID type SYSUUID_X,
     DESCRIPTION type string,
     VALUE type P length 16 decimals 2,
     CURRENCY type C length 5,
     QUANTITY type P length 16 decimals 2,
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZENISB_MPC================CP'. "#EC NOTEXT
...
CLASS ZCL_ZENISB_MPC IMPLEMENTATION.


* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method ZCL_ZENISB_MPC->DEFINE
* +-------------------------------------------------------------------------------------------------+
...
model->set_schema_namespace( 'ShoppingBasket' ).
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Private Method ZCL_ZENISB_MPC->DEFINE_ASSOCIATIONS
* +-------------------------------------------------------------------------------------------------+
* | [!CX!] /IWBEP/CX_MGW_MED_EXCEPTION
* +--------------------------------------------------------------------------------------</SIGNATURE>
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'HeaderItemSet'                         "#EC NOTEXT
 ...
 lo_association = model->create_association(
                            iv_association_name = 'HeaderRequester' "#EC NOTEXT
                            iv_left_type        = 'Header' "#EC NOTEXT
                            iv_right_type       = 'Requester' "#EC NOTEXT
                            iv_right_card       = '1' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'HeaderRequesterSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'HeaderSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'RequesterSet'             "#EC NOTEXT
                                              iv_association_name      = 'HeaderRequester' ).                                 "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ItemSet' "#EC NOTEXT
                                                              ...
                                                              iv_association_name = 'HeaderItem' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'RequesterSet' "#EC NOTEXT
                                                              iv_abap_fieldname = 'REQUESTERSET' "#EC NOTEXT
                                                              iv_association_name = 'HeaderRequester' ). "#EC NOTEXT
endmethod.


* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Private Method ZCL_ZENISB_MPC->DEFINE_HEADER
* +-------------------------------------------------------------------------------------------------+
* | [!CX!] /IWBEP/CX_MGW_MED_EXCEPTION
* +--------------------------------------------------------------------------------------</SIGNATURE>
...
lo_property = lo_entity_type->create_property( iv_property_name = 'BasketGuid' iv_abap_fieldname = 'BASKETGUID' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_true ).
lo_property = lo_entity_type->create_property( iv_property_name = 'BasketNumber' iv_abap_fieldname = 'BASKETNUMBER' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZENISB_MPC=>TS_HEADER' ). "#EC NOTEXT
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Private Method ZCL_ZENISB_MPC->DEFINE_ITEM
* +-------------------------------------------------------------------------------------------------+
* | [!CX!] /IWBEP/CX_MGW_MED_EXCEPTION
* +--------------------------------------------------------------------------------------</SIGNATURE>
method DEFINE_ITEM.
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_true ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ItemGuid' iv_abap_fieldname = 'ITEMGUID' ). "#EC NOTEXT
lo_property->set_type_edm_guid( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_true ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZENISB_MPC=>TS_ITEM' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20180613114609'.                  "#EC NOTEXT
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method ZCL_ZENISB_MPC->LOAD_TEXT_ELEMENTS
* +-------------------------------------------------------------------------------------------------+
